...
if(isset($_GET['divi']) && isset($_GET['jefe'])){
    ...
    $muestra="";
    if(strcmp($jefe+"",1)==0){
        $muestra="<b>Esta división no tiene un jefe Asignado</b>";
    }
    else{
    $usuario=$facade->getUserInformation($jefe, "../");
        $muestra= "El jefe de esta división es <b>".$usuario->_GET('persona')->_GET('nombre')." ".$usuario->_GET('persona')->_GET('apellido').",</b> Con el documento <b>".$usuario->_GET('persona')->_GET('numeroDocumento')."</b>";
    }
}
